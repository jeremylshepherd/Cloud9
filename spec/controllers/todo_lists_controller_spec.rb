...
describe TodoListsController do
  ...
  describe "GET index" do
    context "logged in" do
      ...
      it "does not load other user's todo_lists" do
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "does not allow users to create todo lists for the other users" do
  ...
  describe "DELETE destroy" do
    it "destroys the requested todo_list" do
      todo_list = user.todo_lists.create! valid_attributes
      expect { delete :destroy, {:id => todo_list.to_param }, valid_session }.to change(TodoList, :count).by(-1)
    end
